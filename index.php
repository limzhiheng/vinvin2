...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login'])) {
    ...
    if ($customerResult && mysqli_num_rows($customerResult) == 1) {
        ...
        if (password_verify($loginPassword, $customerRow['password_hash'])) {
            ...
            header("Location: php/c_main.php");
            exit();
        }
    }
    // Invalid login
...
<body>
    <div class="box1">
		...
		<a class="button2" href="php/c_signup.php">Don't have an account?</a>
	</div>
    ...
    <center>
        <div class="box2">
            <div class="login">
                ...
                <form class="login" action="php/c_login.php" method="POST">
                    <center>
                        <p>&#x1F464;Email:</p>
                        ...
                        if (!empty($error)) {
                            ...
                            echo "<br><br><a href='php/c_login.php'>Go back to login</a>";
                        }
                        ?>
